...
struct MenuSection: Codable, Identifiable, Equatable, Hashable {
    ...
    static let dummy = MenuSection(name: "Pizza", image: URL(string: "https://github.com/stuffeddanny/Italiano_files/blob/main/menu/pizza/section_image.png?raw=true")!, items: [.dummy])
}
